       ...
       bg-slate-700 text-white   cursor-pointer p-3 text-center  "
        >
          <div className="text w-80 relative  bg-slate-50 text-black p-2 rounded-md">
            <img
              className=" w-auto   ml-1 rounded-md"
              src={cardDatas.image.url}
            />
            ...
            <span className=" text-center text-black  p-2   space-y-3 font-semibold ">
              {cardDatas.title}
            </span>
            <p className=" text-center">
              {/* substring  */}
              {cardDatas.description.length > 100
                ? cardDatas.description.substr(0, 100)
